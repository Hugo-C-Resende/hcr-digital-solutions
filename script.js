...
"faq.4.text": "Sim — ciclo completo: atualizações regulares, suporte técnico direto (email/telefone) e correção prioritária de falhas críticas. Os termos de SLA são definidos em contrato, conforme a criticidade da aplicação.",
...
"faq.4.text": "Yes — full lifecycle: regular updates, direct technical support (email/phone) and priority fixes for critical issues. SLA terms are defined by contract, based on the application's criticality.",
...
"faq.4.text": "Oui — cycle complet : mises à jour régulières, support technique direct (email/téléphone) et correction prioritaire des anomalies critiques. Les conditions de SLA sont définies par contrat, selon la criticité de l'application.",
